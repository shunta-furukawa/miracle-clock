...
const sources=await Promise.all(['soundtrack.js','time.js','levels.js','elements.js','save.js','dialogue.js','stories.js','depot.js','opening.js','app.js'].map(f=>readFile('src/'+f,'utf8')));
