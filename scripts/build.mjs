...
const sources=await Promise.all(['soundtrack.js','time.js','levels.js','elements.js','save.js','dialogue.js','stories.js','depot.js','detent.js','celebration.js','opening.js','stamp.js','route.js','day.js','app.js'].map(f=>readFile('src/'+f,'utf8')));
