...
### 章と配達日誌
6章×6ステージ（全36便）を順に遊び、時間とミス回数による三つ星に挑戦できます。序盤は1人ずつ来店するため、独立した練習モードはありません。第6章はスナリとトビネズミ族の「砂丘の温室」。全ステージクリア後は、トトじいと全種族の注文を受けるエンドレス「空の中央便」が開きます。3つの日誌に進行・最高評価・中央便の最高／累計便数を個別保存します。旧クリア記録は対応する章へ引き継ぎます（旧タイム未記録のため星は再挑戦で獲得）。
