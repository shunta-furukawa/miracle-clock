...
通常便はライフ3で開始し、誤った刻印または先頭のお客さんの時間切れで1減り、0で失敗します。お客さんは帰って次の人に進みます。待ち時間は先頭に立ってから計測し、後ろの人・一時停止・配送演出中は進みません。ハートが残ったまま全員の受付を終えるとクリア。失敗後はライフ3で再挑戦、またはその便だけライフ6のおてつだいを選べます。次の便は3に戻ります。おてつだいでも進行・星評価の条件は同じです。特別エンドレスもライフ3で開始。不正解は注文を維持して再挑戦し、待ち時間と来客は止まりません。先頭で105秒待つと退場してライフが1減り、ライフ0または行列5人で終了します。
