...
function arrive(o){
 ...
 t.innerHTML=`${residentFace(o)}<span class="ticket-text"><strong>${o.card}</strong><small class="ticket-left"></small></span><i class="ticket-timer" aria-hidden="true"></i>`;
