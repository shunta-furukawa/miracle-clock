...
// and quicken the pace. Morning/afternoon and "in N hours" orders run through every chapter.
...
export const chapterSkills=['正時','30分・半','15分・45分','5分から1分','24時間表記','何時間後・日付またぎ'];
