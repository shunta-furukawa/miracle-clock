...
export const levels = [
  {id:0,title:'はじめての空の便',place:'こもれびの森',skill:'ぴったりの時刻',step:60,count:5,interval:35,format:'12',times:[180,300,540,720,120],intro:'モスから最初のお届けものじゃ。短い針が「時」、長い針が「分」を教えてくれるぞ。',lesson:'短い針を動かしてみよう。長い針は12に合わせるんじゃ。'},
  {id:1,title:'港のティータイム',place:'しおかぜの港',skill:'30分・「半」',step:30,count:6,interval:33,format:'half',times:[210,450,630,90,690,330],intro:'シェルがお茶会の準備中じゃ。「半」は30分。長い針を半周させてみよう。',lesson:'長い針が6なら30分。短い針も、数字と数字の真ん中へ進むぞ。'},
  {id:2,title:'結晶のひかるころ',place:'きらめきの洞窟',skill:'15分・30分・45分',step:15,count:7,interval:31,format:'12',times:[195,345,570,675,135,465,255],intro:'クリムの灯りを届けよう。時計を4つに分けると、15分ずつになるんじゃ。',lesson:'長い針が3なら15分、6なら30分、9なら45分じゃ。'},
  {id:3,title:'工房はおおいそがし',place:'あかねの工房',skill:'5分刻み → 1分刻み',step:5,count:8,interval:33,format:'12',times:[200,490,655,145,382,527,614,299],intro:'フレアの工房から細かな注文じゃ。まず5分ずつ、後半は小さな目盛りを1分ずつ読もう。',lesson:'数字をひとつ進むと5分。小さな目盛りひとつは1分じゃよ。'},
  {id:4,title:'太陽と月の配達便',place:'雲の展望台',skill:'午前・午後・24時間',step:5,count:8,interval:35,format:'period',times:[570,930,0,720,1095,60,1260,765],intro:'フウは夜のお届けも待っておるぞ。同じ針の形でも、午前と午後を選び分けるんじゃ。',lesson:'午後3時は15時。午前0時は夜中、午後0時はお昼の12時じゃ。'},
  {id:5,title:'時をつなぐ空の旅',place:'すべての島へ',skill:'何分後・何時間後',step:5,count:8,interval:38,format:'relative',times:[45,90,150,30,120,75,150,45],intro:'「いまから何分後？」の注文じゃ。受付の時計から針を進めて、お届けする時刻を見つけよう。',lesson:'受付時刻は注文票に残るぞ。長い針を一周させると、1時間先になるんじゃ。'}
];
export function makeOrder(level, index) {
  const person = customers[(level.id + index) % customers.length];
  ...
  return {...person,orderId:index,characterId:person.id,target,base,duration,period,step,label,nextDay:!!duration && base + duration >= 1440};
}
